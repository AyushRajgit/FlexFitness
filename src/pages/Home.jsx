    ...
    <div className="overflow-x-hidden">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { name: "Akash Singh", result: "Lost 30 kg in 3 months", quote: "FlexFitness changed my life completely!" },
              { name: "Gitansh Shekhar", result: "Gained 15 kg muscle", quote: "The trainers here are absolutely amazing." },
